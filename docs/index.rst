...
``h3lib`` is written in C. Python and Java wrappers are also available. An H3 FUSE-based filesystem is also implemented, that allows object access using file semantics.
